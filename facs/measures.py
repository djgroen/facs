...
def uk_lockdown(e, phase=1, transition_fraction=1.0, keyworker_fraction=0.18):
  ...
  if phase == 2: # Enacted March 23rd
    ...
    e.add_social_distance(compliance=0.65 + (transition_fraction * 0.1), mask_uptake=0.05, shopping_mark_uptake=0.1)
  ...
  if phase == 3: # Enacted April 22nd
    ...
    e.add_closure("leisure", 0)
    e.add_partial_closure("shopping", 0.8)
    e.add_social_distance(compliance=0.8, mask_uptake=0.15, shopping_mark_uptake=0.2)
  ...
  if phase == 4: # Enacted May 13th
    ...
    e.add_social_distance(compliance=0.7, mask_uptake=0.2, shopping_mark_uptake=0.3)
  ...
  if phase == 7: # Enacted July 15th
    ...
    e.add_social_distance(compliance=0.7, mask_uptake=0.2, shopping_mark_uptake=1.0)
    e.add_work_from_home(0.5)
